...
function show(button_element) {
    ...
    */
    ...
    let button_id = button_element.id;
    ...
    let fun_facts = facts[button_id];
    console.log(fun_facts);
    document.getElementById('ta-fun-fact').textContent = fun_facts;
    ...
    let photo = 'photos/' + button_element.id + '.jpg';
    console.log(photo);
    ...
    document.getElementById(button_id).style.backgroundColor = 'aqua';
    document.getElementById(button_id).style.color = 'black';

    if (lastSelectedButton) {
        lastSelectedButton.style.backgroundColor = 'darkblue';
        lastSelectedButton.style.color = 'white';
    }
    ...
    lastSelectedButton = button_element;
